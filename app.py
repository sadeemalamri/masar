...
# ============================================================
# 2) TRANSLATIONS (UI defaults to English; can be switched to Arabic)
# ============================================================
TRANSLATIONS = {
    "en": {
        "app_title": "Masar",
        ...
        "hitl_checkpoint": (
            ...
            "Review the path, then click \"Approve\" to generate educational "
        ...
        "no_pending": "⚠️ There is no recommendation pending approval.",
        "click_first": "⚠️ Please click \"Discover My Path\" first.",
        ...
        "required_msg": "⚠️ Please enter your {field}.",
        "too_long_msg": "⚠️ Your {field} entry is too long. Maximum {max} characters.",
    },
    "ar": {
        "app_title": "مسار",
        "app_subtitle": "اكتشف مسارك الأنسب لمستقبلك في المملكة",
        "start_here": "🌿 أبدأ من هنا",
        "label_major": "* التخصص المفضل",
        "label_edu": "* المستوى التعليمي",
        "label_interests": "* الاهتمامات",
        "label_goal": "* هدفك من التطوير",
        "label_duration": "* الوقت المتاح للتعلم",
        "label_skills": "* المهارات التي تمتلكها",
        "skills_placeholder": "مثال: Python, SQL, Excel",
        "analyze_btn": "✨ اكتشف مساري",
        "system_status": "🛡️ حالة النظام",
        "status_waiting_input": "في انتظار إدخال بيانات المستخدم.",
        "skills_needed": "📊 المهارات التي تحتاجها",
        "waiting_input_short": "في انتظار مدخلاتك...",
        "why_path": "💡 لماذا هذا المسار؟",
        "suggested_path": "⭐ المسار المقترح لك",
        "best_jobs": "💼 أفضل الوظائف المناسبة لك",
        "dev_plan": "🗓️ خطة التطوير",
        "hitl_title": "👤 أكد موافقتك",
        "hitl_desc": "سوف يتم إنشاء الموارد التعليمية بعد موافقتك.",
        "approve_btn": "✅ موافق على المسار",
        "reject_btn": "🔄 أريد تعديل البيانات",
        "resources_title": "📚 موارد تعليمية مقترحة",
        "resources_waiting": "في انتظار موافقة المستخدم...",
        "memory_title": "🧠 Memory / Context",
        "memory_empty": "لا توجد توصيات محفوظة في الجلسة حتى الآن.",
        "match_label": "نسبة المطابقة",
        "verified_link": "✓ تم التحقق من الرابط",
        "no_resources": "لم يتم العثور على روابط تم التحقق منها حالياً.",
        "month_label": "الشهر",
        "no_results_yet": "لا توجد نتائج بعد.",
        "hitl_checkpoint": (
            "🟡 **HITL Checkpoint:** تم إنشاء التوصية. "
            "راجعي المسار ثم اضغطي «موافق» لإنشاء الموارد التعليمية، "
            "أو «أريد تعديل البيانات» إذا أردتِ تعديل مدخلاتك."
        ),
        ...
        "no_pending": "⚠️ لا توجد توصية بانتظار الموافقة.",
        "click_first": "⚠️ الرجاء الضغط على «اكتشف مساري» أولاً.",
        "resource_error": "❌ فشل إنشاء الموارد.",
        "approved_status": (
            "✅ تمت الموافقة البشرية على التوصية، "
            "ثم تم تشغيل Agent 3 للحصول على الموارد."
        ),
        "memory_saved": (
            "🧠 **Memory:** تم حفظ آخر توصية في ذاكرة الجلسة. "
            "المسار المحفوظ: {path}. عدد التوصيات المحفوظة: {count}"
        ),
        "reset_message": "🔄 عدّلي بياناتك ثم اضغطي «اكتشف مساري» مرة أخرى.",
        "reset_status": "🔄 تم رفض التوصية الحالية. لم يتم تشغيل Agent 3.",
        ...
        "required_msg": "⚠️ الرجاء إدخال {field}.",
        "too_long_msg": "⚠️ إدخال {field} طويل جداً. الحد الأقصى {max} حرف.",
    },
}

LANGUAGE_NAME = {"en": "English", "ar": "Arabic"}

# Map every "placeholder" string (in either language) back to its translation key,
# so a language switch can safely refresh only components still showing a placeholder.
PLACEHOLDER_KEYS = [
...
def validate_inputs(major, edu_level, interests, goal, duration, skills, lang="en"):
    """Guardrail: validates required inputs and blocks suspicious instructions."""
...
def extract_months(duration):
    """
    Extract the number of months selected by the user.
    Example:
    '6 Months' -> 6
    '1 Month' -> 1
    """
...
# 5) TOOL INTEGRATION
# Tool 1: OpenAI API
# Tool 2: URL Validator
# ============================================================
def is_valid_url(url: str) -> bool:
    """Validate URL format and check whether the website is reachable."""
    ...
    try:
        ...
        try:
            ...
            # Some websites reject HEAD but are still valid.
...
def validate_learning_resources(resources):
    """
    Validates generated resource URLs before showing them to the user.
    """
...
- Do not create more or fewer months.
- The "month" field must go from 1 to {months}.
- Make the roadmap progressive and realistic.
- Distribute the learning topics across the selected duration.
- If the user selects 3 months, return exactly 3 roadmap items.
- If the user selects 6 months, return exactly 6 roadmap items.
- If the user selects 12 months, return exactly 12 roadmap items.
...
- skills_required: array of objects
  {{
    "name": "Python",
    "level": "Good level",
    "percentage": 85
...
- top_jobs: array of objects
  {{
    "title": "Data Analyst",
    "match": "92%"
  }}

- roadmap: array of exactly {months} objects
  {{
    "month": "1",
    "icon": "💻",
        ...
        messages=[
            {
                "role": "system",
                "content": (
                    "You are a safe career analysis agent. "
...
The user's selected learning duration is:

{duration}

Your responsibilities:

1. Check consistency between career path, skills, jobs and roadmap.
2. Improve clarity and usefulness.
3. Ensure percentages are between 0 and 100.
4. Keep the recommendation realistic and educational.
5. Do not invent real-time labor-market statistics.
...
- Do not add or remove months.
- The "month" field must go from 1 to {months}.
- The roadmap must match the user's selected duration.
- Keep the roadmap progressive and realistic.
...
"""
    ...
    # --------------------------------------------------------
    # Safety check:
    # Make sure roadmap has EXACTLY the selected duration.
    # --------------------------------------------------------
    ...
    if len(roadmap) != months:
        ...
        # If AI returned too many/few items,
        # ask the model to correct it.
        correction_prompt = f"""
Fix the following roadmap.

The required duration is exactly {months} months.

Current roadmap:
{json.dumps(roadmap, ensure_ascii=False)}

Return ONLY a JSON array containing exactly {months} objects.
...
The month values must be 1 through {months}.
"""
        ...
        correction_data = json.loads(
            correction_response.choices[0].message.content
        )

        corrected_roadmap = correction_data.get(
            "roadmap",
            correction_data.get("items", [])
        )

        if isinstance(corrected_roadmap, list):
            result["roadmap"] = corrected_roadmap[:months]

    # --------------------------------------------------------
    # Final normalization
    # --------------------------------------------------------

    result["roadmap"] = result.get("roadmap", [])[:months]

    for index, step in enumerate(result["roadmap"], 1):
...
Suggest up to 8 well-known educational resources
relevant to this career path.

IMPORTANT:

- Prefer official provider URLs.
- Use direct, stable provider or course URLs when known.
- Do not invent domains.
- If you are uncertain about a specific course URL,
  use the official provider catalog URL instead.
...
"""
        ...
        messages=[
            {
                "role": "system",
                "content": (
                    "You provide educational resources. "
                    "Return only valid JSON and avoid fabricated URLs."
                ),
            },
    ...
    # Tool 2 integration
    data["resources"] = validate_learning_resources(
        data.get("resources", [])
    )
...
def update_memory(
    ...
    # Keep only latest 5 interactions
...
def build_results_html(data, lang="en"):
    ...
    badges_html = "".join(
        [
            f'<span class="badge">{html.escape(str(b))}</span>'
    ...
    <div style="text-align: center;">
        ...
        <div class="match-circle">
            ...
            <div class="match-label">
                {html.escape(match_label)}
            </div>

        </div>

        <h2 style="color: #005A36; margin: 5px 0;">
            {html.escape(str(data.get("path_title", "")))}
        </h2>

        <p style="color: #4a5568; font-size: 13px;">
            {html.escape(str(data.get("path_desc", "")))}
        </p>
    ...
    for skill in data.get("skills_required", []):
        ...
        <div class="skill-row">
            ...
            <div class="skill-label">
                ...
                <span>
                    {html.escape(str(skill.get("name", "")))}
                </span>
...
def build_resources_html(resources, lang="en"):
    ...
    if not resources:
        ...
        return (
            f"<p style='color:#b45309;'>"
            f"{html.escape(tr(lang, 'no_resources'))}"
            f"</p>"
        )
...
# ============================================================
# 12) HITL STEP 1
# Input -> Agent 1 -> Agent 2 -> Human Approval
# ============================================================
def analyze_for_approval(
    major,
    edu_level,
    interests,
    goal,
    ...
    if not is_valid:
        ...
        return (
            ...
            error,
            error,
            f"<p>{html.escape(tr(lang, 'no_results_yet'))}</p>",
            tr(lang, "guardrail_stopped"),
            pending_state,
        )
    ...
    try:
        ...
        (
            ...
            jobs_html,
            roadmap_html
        ) = build_results_html(agent2, lang)
        ...
        return (
            ...
            jobs_html,
            roadmap_html,
            f"<p>{html.escape(tr(lang, 'awaiting_approval'))}</p>",
            status,
            pending_state,
        )
        ...
        error = (
            f"<p style='color:red;'>"
            f"{html.escape(tr(lang, 'analysis_error'))} "
            f"{html.escape(str(e))}"
            f"</p>"
        )
...
def approve_recommendation(
    ...
    if (
        not pending_state
        or not pending_state.get("recommendation")
    ):

        return (
            f"<p style='color:red;'>{html.escape(tr(lang, 'no_pending'))}</p>",
            tr(lang, "click_first"),
            memory_state,
            "",
        )
    ...
    try:
        ...
        recommendation = pending_state[
            "recommendation"
        ]

        result_lang = pending_state.get("lang", lang)

        # Agent 3 runs ONLY after human approval
        resources_data = agent_3_url_finder(
            recommendation
        )

        resources_html = build_resources_html(
            resources_data.get(
                "resources",
                []
            ),
        ...
        memory_text = tr(
            lang,
            "memory_saved",
            path=recommendation.get('path_title', ''),
            count=len(updated_memory.get('history', [])),
        )
        ...
        return (
            ...
            f"""
            <p style='color:red;'>
                {html.escape(tr(lang, 'error_generic'))}
                {html.escape(str(e))}
            </p>
            """,

            tr(lang, "resource_error"),
...
def reset_recommendation(lang):
    ...
    return (
        ...
        f"<p>{html.escape(tr(lang, 'reset_message'))}</p>",

        tr(lang, "reset_status"),
...
def switch_language(
    ...
    lang = "en" if choice == "English" else "ar"
...
/* RTL mode is toggled on/off client-side via the language switcher */
.gradio-container.rtl-mode {
...
/* ============================================================
   LIGHT GREEN THEME FOR ALL BOXES
   ============================================================ */
...
.card-box {
    ...
    box-shadow: 0 2px 8px rgba(0, 90, 54, 0.06) !important;
}

/* Gradio Blocks inside cards */
.card-box > div,
.card-box .block,
.card-box .form,
.card-box .wrap,
...
.card-box .timeline-step {
    color: #FFFFFF !important;
    background-color: #005A36 !important;
}

/* Timeline cards */
.card-box .timeline-card {
    background-color: #F8FCF9 !important;
    border: 1px solid #D6EADF !important;
}

/* Skills bars */
.card-box .skill-bar-bg {
    background-color: #DDEFE4 !important;
}

.card-box .skill-bar-fill {
    background-color: #005A36 !important;
}

/* Make selected/user-entered text black */
...
/* Fix dropdown menu popup background & option text */
...
/* Highlighted / Hovered option in dropdown */
...
# JS that flips the container's text direction when the language changes.
DIR_JS = """
(choice) => {
    ...
    if (choice === 'العربية') {
        ...
        container.classList.remove('rtl-mode');
...
worldwide_majors = [
    ...
    "Supply Chain Management (إدارة سلاسل الإمداد)",

    "Mathematics (الرياضيات)",

    "Statistics (الإحصاء)",

    "Medicine & Surgery (الطب والجراحة)",
    ...
    "Education & Pedagogy (التربية والتعليم)",

]


# ============================================================
# 18) LEARNING DURATIONS
# ============================================================
learning_durations = [
...
with gr.Blocks(
    ...
    # --------------------------------------------------------
    # Session State = Memory + current language
    # --------------------------------------------------------
    ...
    with gr.Column(
        elem_classes=["card-box"]
    ):

        start_here_out = gr.HTML(
            section_title_html(TRANSLATIONS["en"]["start_here"])
        )


        with gr.Row():

            pref_major = gr.Dropdown(

                choices=worldwide_majors,

                label=TRANSLATIONS["en"]["label_major"],
            ...
            edu_level = gr.Dropdown(
                ...
                choices=[
                    ...
                    "Bachelor's Degree (بكالوريس)",

                    "Master's Degree (ماجستير)",

                ],

                label=TRANSLATIONS["en"]["label_edu"],
            ...
            interests = gr.Textbox(
                ...
                label=TRANSLATIONS["en"]["label_interests"],
        ...
        with gr.Row():
            ...
            dev_goal = gr.Textbox(
                ...
                label=TRANSLATIONS["en"]["label_goal"],

            )


            avail_time = gr.Dropdown(

                choices=learning_durations,

                label=TRANSLATIONS["en"]["label_duration"],
            ...
            skills_input = gr.Textbox(
                ...
                label=TRANSLATIONS["en"]["label_skills"],

                placeholder=TRANSLATIONS["en"]["skills_placeholder"],
    ...
    with gr.Column(
        ...
        system_status_out = gr.HTML(
            section_title_html(TRANSLATIONS["en"]["system_status"])
        )

        status_out = gr.Markdown(
            TRANSLATIONS["en"]["status_waiting_input"]
        )
    ...
    with gr.Row():
        ...
        with gr.Column(
            ...
            skills_title_out = gr.HTML(
                section_title_html(TRANSLATIONS["en"]["skills_needed"])
            )

            skills_out = gr.HTML(
                TRANSLATIONS["en"]["waiting_input_short"]
            )
        ...
        with gr.Column(
            ...
            reasons_title_out = gr.HTML(
                section_title_html(TRANSLATIONS["en"]["why_path"])
            )
        ...
        with gr.Column(
            ...
            path_title_out = gr.HTML(
                section_title_html(TRANSLATIONS["en"]["suggested_path"])
            )
    ...
    with gr.Row():
        ...
        with gr.Column(
            ...
            jobs_title_out = gr.HTML(
                section_title_html(TRANSLATIONS["en"]["best_jobs"])
            )
        ...
        with gr.Column(
            ...
            roadmap_title_out = gr.HTML(
                section_title_html(TRANSLATIONS["en"]["dev_plan"])
            )
    ...
    with gr.Column(
        ...
        resources_title_out = gr.HTML(
            section_title_html(TRANSLATIONS["en"]["resources_title"])
        )

        resources_out = gr.HTML(
            TRANSLATIONS["en"]["resources_waiting"]
        )
    ...
    with gr.Column(
        ...
        memory_title_out = gr.HTML(
            section_title_html(TRANSLATIONS["en"]["memory_title"])
        )

        memory_out = gr.Markdown(
            TRANSLATIONS["en"]["memory_empty"]
        )
